...
public class Persistencia_a09_Pedido_Projeto {
    ...
    public Persistencia_a09_Pedido_Projeto() {}


    public Persistencia_a09_Pedido_Projeto(int a09_id_pedido, int a09_id_projeto,
