...
public class Persistencia_a05_Manutencao {
    ...
    public Persistencia_a05_Manutencao() {}


    public Persistencia_a05_Manutencao(int a05_id_manutencao, int a05_id_produto, int a05_id_localizacao,
