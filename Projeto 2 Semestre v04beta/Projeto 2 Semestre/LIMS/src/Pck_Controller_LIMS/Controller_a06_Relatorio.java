...
public class Controller_a06_Relatorio {
    ...
    public Controller_a06_Relatorio() {}


    public Controller_a06_Relatorio(int a06_id_relatorio, int a06_id_projeto, int a06_id_produto,
